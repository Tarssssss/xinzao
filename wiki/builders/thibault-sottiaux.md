...
- **委派边界示范（新，2026-07-19）**：转向推 ChatGPT Work，称「工作基本就是靠口述委派」。信息量在他晒出的那条口述任务本身——让 agent 把上千条私信整理成表，并自己发明一套 8-12 标签的分类体系、按成熟度打分再分层抽样，等于把「设计结构」这步也外包出去。仍是产品推广（他是该产品线负责人），可核验的只有这段 prompt 的粒度，产出好坏无佐证。呼应 6-10 Alex Albert「从下发任务改成描述目标」的迁移建议（2026-07-19-sottiaux-chatgpt-work-delegation）。
...
- 2026-07-19 [2026-07-19-sottiaux-chatgpt-work-delegation] 演示口述把复杂任务委派给 ChatGPT Work：让 agent 自己给上千条私信设计 8-12 标签分类体系、按成熟度打分并分层抽样，示范「连拆解一起外包」
