...
- 2026-07-25 [2026-07-25-levie-box-opus5-enterprise-eval] Box 评测给 Opus 5 读数：尽调 +17%、生命科学 +30%，重点是 4.8 的两种错法（清单变长就停、部分匹配也收进来）；只给涨幅未给绝对分
- 2026-07-25 [2026-07-25-open-weights-letter-positions] Box 签署支持开放权重的公开信，给出四条机制（垂直后训练层、安全处理多样性、替代训练路线、成本结构分层），结论是开源闭源非零和
